...
<div class="">
  <div class="border-b border-gray-800">
      <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row ">
          <img :src="'https://image.tmdb.org/t/p/w500/'+movie.poster_path" :alt="movie.name" class="w-64 md:w-96" >
          <div class="md:ml-24">
              <h2 class="text-4xl font-semibold">{{movie.name}} </h2>
               <div class="flex flex-wrap items-center text-gray-400  text-sm">
                            ...
                            <span>| {{movie.genres}} |{{movie.first_air_date}} </span>
...
export default {
    ...
    methods: {
        async fetchMovie(){
            ...
            const {data} = await axios.get('https://api.themoviedb.org/3/tv/'+id+'?api_key=ac968b9ed1563dd411c406bfeb7acf85&append_to_response=credits,videos,images');
            this.movie=data;
            console.log(data);
